...
-(void) executeSqlBatchNow: (CDVInvokedUrlCommand*)command
{
...

    {
        for (NSMutableDictionary *dict in executes) {
            ...
            if ([results.status intValue] == CDVCommandStatus_ERROR) {
                /* add error with results.message: */
                NSMutableDictionary *r = [NSMutableDictionary dictionaryWithCapacity:0];
                [r setObject:@"error" forKey:@"type"];
                [r setObject:results.message forKey:@"error"];
                [r setObject:results.message forKey:@"result"];
                [results addObject: r];
            } else {
                /* add result with results.message: */
                NSMutableDictionary *r = [NSMutableDictionary dictionaryWithCapacity:0];
