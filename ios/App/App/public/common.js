...
/***/ 3249:
/*!****************************************!*\
  !*** ./src/app/models/SearchFilter.ts ***!
  \****************************************/
...
class SearchFilter extends _BaseModel__WEBPACK_IMPORTED_MODULE_0__.BaseModel {
...
class Vehicle extends _BaseModel__WEBPACK_IMPORTED_MODULE_0__.BaseModel {
    constructor(requestJSON) {
        super(requestJSON);
...
/* harmony import */ var _localStorage_local_storage_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../localStorage/local-storage.service */ 8565);
...
let LanguageService = class LanguageService {
  constructor(alertController, translateService, localStorageService) {
  ...
  createLanguageList() {
    if (this.languageList == null || this.languageList == undefined || this.languageList.length == 0) this.languageList = [{
      "name": 'English',
      "label": 'English',
      "value": 'en',
      "type": "radio",
  ...
  setLanguage(language) {
    this.createLanguageList();
    this.localStorageService.setItem(src_assets_constants_constants__WEBPACK_IMPORTED_MODULE_1__.KeywordConstants.SELECTED_APP_LANGUAGE, language).then(() => {
      this.localStorageService.StoredPreference.SelectedLanguage = language;
    });
    ;
    this.languageList.forEach(languageObject => {
      if (languageObject["value"] == language) languageObject["checked"] = true;else languageObject["checked"] = false;
    });
  ...
  getDeviceLanguage() {
    if (this.localStorageService.StoredPreference.SelectedLanguage != null && this.localStorageService.StoredPreference.SelectedLanguage != undefined) {
      ...
      if (window.Intl && typeof window.Intl === 'object') {
        if (navigator.language == "en-US") this._initTranslate("en");else this._initTranslate(navigator.language);
      } else {}
    }
  }
  ...
  presentLanguageSelctionMenu(changed) {
    var _this = this;
    ...
    return (0,C_CodeBase_capacitor_vehiclesearch_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const alert = yield _this.alertController.create({
        ...
        header: _this.translate("GENERAL.LANGUAGE"),
        inputs: _this.getLanguageList(),
        buttons: [{
          text: _this.translate("BUTTONS.CANCEL"),
          role: 'cancel',
          cssClass: 'secondary',
          handler: result => {
          ...
          cssClass: 'primary',
          text: _this.translate("BUTTONS.OK"),
          handler: result => {
            _this.setLanguage(result);
...
LanguageService.ctorParameters = () => [{
  ...
  type: _localStorage_local_storage_service__WEBPACK_IMPORTED_MODULE_2__.LocalStorageService
}];

LanguageService = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Injectable)({
  providedIn: 'root'
})], LanguageService);
...
/***/ 8097:
/*!*****************************************************************!*\
  !*** ./src/app/services/visualization/visualization.service.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VisualizationService": () => (/* binding */ VisualizationService),
/* harmony export */   "VisualizationURLs": () => (/* binding */ VisualizationURLs)
/* harmony export */ });
...
/* harmony import */ var _vehicle_vehicle_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../vehicle/vehicle.service */ 4093);
...
class VisualizationURLs {
}
VisualizationURLs.GET_LOCALIZATION_BY_SHOW_BY_FIELD_APP_SCRIPT = src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.appScriptApiURL + '?sheetid=' + src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.SpreadsheetId + '&visualize=chart&showby={SHOW_BY}&sheetname=Vehicles';
let VisualizationService = class VisualizationService {
    constructor(securityService, networkService) {
        this.securityService = securityService;
        this.networkService = networkService;
        this.showBy = new Array();
        this.LoadMetaData();
    }
    LoadMetaData() {
        this.networkService.get(_vehicle_vehicle_service__WEBPACK_IMPORTED_MODULE_3__.VehicleURLs.LOAD_METADATA_APP_SCRIPT, response => {
    ...
    loadVisualization(selectedField, success, failure) {
...
VisualizationService.ctorParameters = () => [
...
VisualizationService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_CodeBase_capacitor_vehiclesearch_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_CodeBase_capacitor_vehiclesearch_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_CodeBase_capacitor_vehiclesearch_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
