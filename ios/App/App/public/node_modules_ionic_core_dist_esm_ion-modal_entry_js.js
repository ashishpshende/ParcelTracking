...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref = (0,C_CodeBase_capacitor_vehiclesearch_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  const onMove = detail => {
     ...
     * so we omit adding 0 to the results.
     */
...
const Modal = class {
  ...
  initSwipeToClose() {
    ...
    this.gesture = createSwipeToCloseGesture(el, ani, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,C_CodeBase_capacitor_vehiclesearch_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
