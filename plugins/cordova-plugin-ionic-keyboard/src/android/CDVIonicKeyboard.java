...
import org.apache.cordova.Pluginresults.Status;
        ...
        if ("init".equals(action)) {
            cordova.getThreadPool().execute(new Runnable() {
                public void run() {
                    ...
                    list = new OnGlobalLayoutListener() {
                        ...
                        public void onGlobalLayout() {
                            ...
                            if (pixelHeightDiff > 100 && pixelHeightDiff != previousHeightDiff) { // if more than 100 pixels, its probably a keyboard...
                                ...
                                result = new PluginResult(Pluginresults.Status.OK, msg);
                    ...
                    PluginResult dataResult = new PluginResult(Pluginresults.Status.OK);
                    dataresults.setKeepCallback(true);
